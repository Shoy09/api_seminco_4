...
public sealed class OperacionScalamin
{
    ...
    public OperacionScalaminCondicionEquipo? CondicionEquipo { get; set; }
    public List<OperacionScalaminHorometro> Horometros { get; set; } = [];
    public List<OperacionScalaminChecklistRespuesta> ChecklistRespuestas { get; set; } = [];
    public List<OperacionScalaminControlLlanta> ControlLlantas { get; set; } = [];
    public List<OperacionScalaminRegistro> Registros { get; set; } = [];
}
