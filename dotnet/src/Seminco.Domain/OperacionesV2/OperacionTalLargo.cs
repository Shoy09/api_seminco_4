...
public sealed class OperacionTalLargo
{
    ...
    public OperacionTalLargoCondicionEquipo? CondicionEquipo { get; set; }
    public List<OperacionTalLargoHorometro> Horometros { get; set; } = [];
    public List<OperacionTalLargoChecklistRespuesta> ChecklistRespuestas { get; set; } = [];
    public List<OperacionTalLargoControlLlanta> ControlLlantas { get; set; } = [];
    public List<OperacionTalLargoRegistro> Registros { get; set; } = [];
}
